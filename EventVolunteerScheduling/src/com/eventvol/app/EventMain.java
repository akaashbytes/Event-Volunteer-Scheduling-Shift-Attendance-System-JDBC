...
// DEMO 1: Register a volunteer
       try {
        ...
        v.setVolunteerID("VOL2001");
        v.setFullName("Hari");
        v.setSkillCategory("REGISTRATION");
        v.setPrimaryPhone("9876543210");
        v.setEmail("hari.krishnan@example.com");
        v.setStatus("ACTIVE");
...
// DEMO 3: Assign volunteer to shift
       try {
        boolean ok = eventService.assignVolunteerToShift("VOL2001", 410027,"ENTRY_CHECK");
