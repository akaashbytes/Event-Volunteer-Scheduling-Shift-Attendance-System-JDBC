...
public class EventService {
    ...
    public boolean assignVolunteerToShift(
            ...
            int shiftID,
            String role)
            throws ValidationException, OverlappingShiftAssignmentException {
        Connection con = null;
        try {
    ...
    public boolean markAttendance(
            ...
            String checkoutTime)
            throws ValidationException {
        if (assignmentID <= 0 || (!"PRESENT".equalsIgnoreCase(attendanceStatus) && !"ABSENT".equalsIgnoreCase(attendanceStatus))) {
            throw new ValidationException();
        }
    ...
    public boolean removeVolunteer(String volunteerID)
            throws ValidationException, ActiveAssignmentsExistException {
        if (volunteerID == null || volunteerID.trim().isEmpty()) {
            throw new ValidationException();
        }
